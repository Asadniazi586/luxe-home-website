...
const AdminProducts = () => {
  ...
  return (
    <AdminLayout>
      <div className="mb-6">
        <h1 className="text-3xl font-light text-gray-800">Products</h1>
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-warm"
        />
      </div>
      ...
      {fetchLoading ? (
        ...
        <div className="bg-white rounded-xl p-12 text-center">
          ...
          <p className="text-gray-500 mt-1">Click "Add Product" from the sidebar to create your first product</p>
        </div>
      ) : (
