...
import { FiChevronDown, FiCheck, FiCreditCard, FiHome, FiLock } from 'react-icons/fi'
...
const Checkout = () => {
  ...
  const paymentMethods = [
    ...
    { id: 'alfalah', name: 'Alfalah Payment Gateway', icon: '🏦', description: 'Direct bank transfer' },
    { id: 'baadmay', name: 'BaadMay | Buy Now. Pay Later', icon: '📅', description: 'Split payments into 3 easy installments' },
  ]

  // Bank Accounts Data
  const bankAccounts = [
    { id: 1, bankName: 'Habib Bank Limited (HBL)', accountTitle: 'LUXE HOME Pvt Ltd', accountNumber: '1234-567890-01', iban: 'PK36HABB0012345678901', swiftCode: 'HABBPKKA' },
    { id: 2, bankName: 'United Bank Limited (UBL)', accountTitle: 'LUXE HOME Pvt Ltd', accountNumber: '9876-543210-02', iban: 'PK78UNIL0098765432102', swiftCode: 'UNILPKKA' },
    { id: 3, bankName: 'Meezan Bank', accountTitle: 'LUXE HOME Pvt Ltd', accountNumber: '2468-135790-03', iban: 'PK92MEZN0024681357903', swiftCode: 'MEZNPKKA' },
    { id: 4, bankName: 'Bank Alfalah', accountTitle: 'LUXE HOME Pvt Ltd', accountNumber: '1357-924680-04', iban: 'PK45ALFH0013579246804', swiftCode: 'ALFHPKKA' },
    { id: 5, bankName: 'National Bank of Pakistan (NBP)', accountTitle: 'LUXE HOME Pvt Ltd', accountNumber: '5791-346820-05', iban: 'PK63NBPA0057913468205', swiftCode: 'NBPPPKKA' }
  ]
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1">
            <form onSubmit={handlePlaceOrder}>
              ...
              {/* Delivery */}
              <div className="bg-white rounded-lg p-6 shadow-sm mb-6">
                <h2 className="text-lg font-medium text-gray-800 mb-4">Delivery</h2>
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm text-gray-600 mb-1">Province/State</label>
                    <select
                      name="state"
                  ...
                  <div>
                    <label className="block text-sm text-gray-600 mb-1">Postal code (optional)</label>
                    <input
                      type="text"
                      name="zipCode"
                ...
                <div className="mt-4 space-y-2">
                  ...
                  <label className="flex items-center gap-2 text-sm text-gray-600">
                    <input type="checkbox" checked={textOffers} onChange={(e) => setTextOffers(e.target.checked)} className="rounded" />
                    Text me with news and offers
                  </label>
                </div>

                <div className="mt-4">
                  <label className="block text-sm text-gray-600 mb-1">CRO / BA code (optional)</label>
                  <input
                    type="text"
                    name="croCode"
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm mb-6">
                ...
                <div className="space-y-3">
                  <label className="flex items-center gap-2 text-sm text-gray-600">
                    <input type="radio" name="billingOption" value="same" checked={billingOption === 'same'} onChange={() => setBillingOption('same')} className="rounded-full" />
                    Same as shipping address
                  </label>
                  <label className="flex items-center gap-2 text-sm text-gray-600">
                    <input type="radio" name="billingOption" value="different" checked={billingOption === 'different'} onChange={() => setBillingOption('different')} className="rounded-full" />
                ...
                <div className="bg-white rounded-lg p-6 shadow-sm mb-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div className="md:col-span-2">
                      ...
                      <input type="text" value="Pakistan" disabled className="w-full px-4 py-2 border border-gray-200 rounded-lg bg-gray-50 text-gray-500" />
                    </div>
                    <div>
                      <label className="block text-sm text-gray-600 mb-1">First name</label>
                      <input type="text" name="firstName" value={billingData.firstName} onChange={handleBillingChange} className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-warm" />
                    </div>
                    <div>
                      <label className="block text-sm text-gray-600 mb-1">Last name</label>
                      <input type="text" name="lastName" value={billingData.lastName} onChange={handleBillingChange} className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-warm" />
                    </div>
                    <div className="md:col-span-2">
                      <label className="block text-sm text-gray-600 mb-1">Address</label>
                      <input type="text" name="address" value={billingData.address} onChange={handleBillingChange} className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-warm" />
                    </div>
                    <div className="md:col-span-2">
                      <label className="block text-sm text-gray-600 mb-1">Apartment, suite, etc. (optional)</label>
                      <input type="text" name="apartment" value={billingData.apartment} onChange={handleBillingChange} className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-warm" />
                    </div>
                    <div>
                      <label className="block text-sm text-gray-600 mb-1">City</label>
                      <input type="text" name="city" value={billingData.city} onChange={handleBillingChange} className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-warm" />
                    </div>
                    <div>
                      <label className="block text-sm text-gray-600 mb-1">Postal code (optional)</label>
                      <input type="text" name="zipCode" value={billingData.zipCode} onChange={handleBillingChange} className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-warm" />
                    </div>
                    <div className="md:col-span-2">
                      <label className="block text-sm text-gray-600 mb-1">Phone (optional)</label>
                      <input type="tel" name="phone" value={billingData.phone} onChange={handleBillingChange} className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-warm" />
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm mb-6">
                ...
                {selectedPaymentMethod === 'baadmay' && (
                  <div className="mt-4 p-4 bg-purple-50 rounded-xl">
                    <h4 className="font-medium text-purple-800 mb-2">Buy Now, Pay Later with BaadMay</h4>
                ...
                {(selectedPaymentMethod === 'payfast' || selectedPaymentMethod === 'alfalah') && (
                                  ...
                                  filteredBanks.map(bank => (
                                    ...
                                    >
                                      <div className="flex justify-between items-center">
                                        ...
                                        {selectedBank?.id === bank.id && <FiCheck className="text-green-500" />}
                                      </div>
                                    </div>
                                  ))
                                ) : (
                                  <div className="px-4 py-8 text-center text-gray-500 text-sm">No banks found</div>
                                )}
                              </div>
                            </div>
                          )}
                ...
                <div className="flex justify-center items-center gap-4">
                  ...
                  <div className="bg-white rounded-lg border border-gray-200 p-2 shadow-sm">
                    <svg width="45" height="28" viewBox="0 0 75 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <text x="10" y="28" fill="white" fontSize="14" fontWeight="bold" fontFamily="Arial">PayPal</text>
                    </svg>
                  </div>
                </div>
